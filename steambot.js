...
server.listen(config1.serverport, config1.serverip, function() {
  console.log("Server running @ http://" + config1.serverip + ":" + config1.serverport);
});
...
MongoClient.connect('mongodb://admin:ktTjfQj3rJ7N@5678572c7628e1101e0000fe-freshboybg.rhcloud.com:62641/csgocafebot', function (err, db) { // Подключаемся к БД
	if (err) {
